...
def decode_p(memory, registers ,pipeline_obj ,buffers , index, btb, gui_util_obj):
    ...
    if pipeline_obj.data_forwarding_knob == 0:
        # Check if rs1 or rs2 are part of Data Hazard
        ...
        if dh == 1:
            ...
            pipeline_obj.call_stalling(index) # index is, at what index this instruction is present in the cycle
                                              # like ["E" ,"D" ] index of decode in this case is 1
                                              
            if ins == 'jal' or ins == 'jalr' or ins == 'beq' or ins == 'bne' or ins == 'bge' or ins == 'blt':
                pipeline_obj.n_contstalls+=1
            else:
                pipeline_obj.n_datastalls+=1
            return
        else:
