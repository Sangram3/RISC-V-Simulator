...
class PipeLine():
    ...
    def __init__(self):
        ...
        self.disable_PC = 0 # Off Program Counter.
        self.finish = 0

        self.n_inst = -1 # to avoid swi instr counting
        self.cpi = 0 # Cycles per instruction
        self.n_datatrans = 0 # Number of data transfer instructions exec.
        self.n_alu_ins = 0 # Number of arithmetic inst. exec.
        self.n_cont_ins = 0 # Number of control instructions exec.
        self.nstalls = 0 # Total stalls
        self.n_datastalls = 0 # Number of stalls due to data hazard
        self.n_contstalls = 0 # Number of stalls due to control hazard
        self.ndhz = 0 # Number of data hazard
        self.nchz = 0 # Number of control hazard
        self.npred = 0 # Number of branch predictions
    ...
    # Stall the pipeline by on cycle
    def call_stalling(self,index): 
    ...
    # make previously fetched instruction NOP : No Operation
    def flush(self):
...
def execute_cycle_util():
    """
        While there are some instructions execute.
    """
...
def execute_cycle():
    ...
    pipeline_obj.pipeline.append([]) # Create next cycle in pipeline

    """
        Execute each instruction present in the pipelines current cycle.
    """
