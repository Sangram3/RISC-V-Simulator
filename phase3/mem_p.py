...
def mem_p(mem_obj, reg_obj, buffers, index, pipeline_obj, cache_ob):   #data in hex with 0x 
    ...
    if(buffers[2].mne == "sw"):
        # sw
        #cache_ob.write(hex(buffers[2].MAR), hex(buffers[2].RM), mem_obj)
        ...
        # lw  
        x = cache_ob.read(hex(buffers[2].MAR), mem_obj)
