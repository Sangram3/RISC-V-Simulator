...
class cache:
    ...
    def __init__(self, cache_size, block_size, ways):
        ...
        self.cache_array = [[["tag", 0, "data"] for _ways in range(ways)] for _set in range(self.set_count)]
    ...
    def read(self, address):
        ...
        if(hit):
            self.hit+=1
            return self.cache_array[index][way_no][2]    #BO would be used here

        else:
            #data = mem_mod.read(address)
